...
class ImLivechatChannel(models.Model):
    ...
    title_color = fields.Char(default="#fff", help="Default title color of the channel once open")
    button_background_color = fields.Char(default="#875A7B", help="Default background color of the Livechat button")
    button_text_color = fields.Char(default="#fff", help="Default text color of the Livechat button")
